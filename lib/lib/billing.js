...
const PLANS = {
  ...
  pro: {
    priceId: process.env.STRIPE_PRICE_PRO, // £14.99/mo
    buildsPerMonth: 30, maxProjects: 8, swarmSlots: 1, teamSeats: 1, sso: false, industryContext: false, whiteLabel: false
  },
  unlimited: {
    priceId: process.env.STRIPE_PRICE_UNLIMITED, // £34.99/mo
    buildsPerMonth: 150, maxProjects: Infinity, swarmSlots: 2, teamSeats: 1, sso: false, industryContext: false, whiteLabel: true
  },
  ultimate: {
    priceId: process.env.STRIPE_PRICE_ULTIMATE, // Custom - contact sales, no fixed price
